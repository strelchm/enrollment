...
public interface ImportsApi {
   ...
   * - товар или категория могут не иметь родителя (при обновлении parentId на null,
   * элемент остается без родителя)
   ...
   */
  void importsPost(ShopUnitImportRequest shopUnitImportRequest);
}
